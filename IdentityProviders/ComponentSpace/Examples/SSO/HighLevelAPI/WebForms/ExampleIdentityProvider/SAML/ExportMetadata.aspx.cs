    ...
    public partial class ExportMetadata : System.Web.UI.Page
    {
        ...
        protected void DownloadButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                IList<X509Certificate2> x509Certificates = SAMLController.CertificateManager.GetLocalIdentityProviderSignatureCertificates(SAMLController.ConfigurationID, partnerName);

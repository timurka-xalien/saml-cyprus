        ...
        private static void LoadMuliTenantedSAMLConfigurationProgrammatically()
        {
            ...
            samlConfiguration.AddPartnerIdentityProvider(
                new PartnerIdentityProviderConfiguration()
                {
                    ...
                    SignAuthnRequest = true,
                    SingleSignOnServiceUrl = "http://localhost/ExampleIdentityProvider2/SAML/SSOService.aspx",
                    SingleLogoutServiceUrl = "http://localhost/ExampleIdentityProvider2/SAML/SLOService.aspx",
                    PartnerCertificateFile = @"certificates\idp.cer"
                });
